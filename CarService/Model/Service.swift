...
extension Log {
    var data: Log {
        Log(date: date, car: car, type: type, milage: milage, details: details, vendor: vendor, cost: cost)
    }
...
extension Service {
    ...
    static let sampleServices: [Service] = [
        ...
        Service(date: convertDate(date: "2022-04-012"), car: Car2.porsche, type: ServiceType.odometer, milage: 80000, details: "", vendor: "", cost: 0),
...
extension Car {
    ...
    static let sampleCars: [Car] = [
        Car(year: "2012", make: "Lexus", model: "IS250"),
        Car(year: "2018", make: "Nissan", model: "Pathfinder"),
        Car(year: "2006", make: "Porsche", model: "Cayman"),
    ]
}
